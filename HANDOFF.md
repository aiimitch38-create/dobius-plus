...
| Task | State |
|---|---|
| TASK-1.1 shell classification | not started |
| TASK-1.2 shell execution + window approval | not started |
| TASK-1.3 shell IPC + tool registration | not started |
| TASK-2.1 model-writable memory | not started |
| TASK-3.1 proactive engine | not started |
| TASK-4.1 plugin loader | not started |
| TASK-4.2 ElevenLabs tool sync | not started |
| TASK-4.3 generic plugin dispatch | not started |
