 ...
 *  dobius-logo.css) and the test-loader has no CSS stub. The
...
} from "@comms/features/agents/ui/agentSessionTranscriptGrouping.ts";
import { observerEventScrollId } from "@comms/features/agents/ui/agentSessionPanelLayout.ts";
...
const { useStableArrayShallow } = await import(
  "@comms/shared/hooks/useStableReference.ts"
);
...
// DobiusMark.tsx → dobius-logo.css). The test below verifies the
