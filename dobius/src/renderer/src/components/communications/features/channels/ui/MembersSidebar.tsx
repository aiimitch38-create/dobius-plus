...
import { attachManagedAgentToChannel } from "@comms/features/agents/channelAgents";
import {
  coalesceAgentAutocompleteCandidates,
  isAgentIdentityInManagedList,
} from "@comms/features/agents/lib/agentAutocompleteEligibility";
import { useIsArchivedPredicate } from "@comms/features/identity-archive/hooks";
import { useClassifiedMembers } from "@comms/features/channels/lib/useClassifiedMembers";
import { formatMemberName } from "@comms/features/channels/lib/memberUtils";
import {
...
import { formatOwnerLabel } from "@comms/features/profile/lib/identity";
import { rankUserCandidatesBySearch } from "@comms/features/profile/lib/userCandidateSearch";
import { usePresenceQuery } from "@comms/features/presence/hooks";
import { useIdentityQuery } from "@comms/shared/api/hooks";
import { changeChannelMemberRole } from "@comms/shared/api/tauri";
import type {
...
import { useFeedbackToasts } from "@comms/shared/hooks/useToastEffect";
...
} from "@comms/shared/ui/modalSearchStyles";
import { MembersSidebarMemberCard } from "./MembersSidebarMemberCard";
import { useManagedAgentRuntimesQuery } from "@comms/features/agents/managedAgentRuntimeHooks";
import {
  findManagedAgentRuntime,
  managedAgentPairAction,
} from "@comms/features/agents/managedAgentRuntimeStatus";
