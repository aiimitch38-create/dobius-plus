...
import { isManagedAgentActive } from "@comms/features/agents/lib/managedAgentControlActions";
import {
  mergeObserverEventWindows,
  observerEventScrollId,
  scopeByChannel,
} from "@comms/features/agents/ui/agentSessionPanelLayout";
import { deriveTranscriptBlockIds } from "@comms/features/agents/ui/agentSessionTranscriptGrouping";
import type { ObserverEvent } from "@comms/features/agents/ui/agentSessionTypes";
import { ManagedAgentSessionPanel } from "@comms/features/agents/ui/ManagedAgentSessionPanel";
import {
  useArchivedChannelEvents,
  useObserverEvents,
} from "@comms/features/agents/ui/useObserverEvents";
import { useAnchoredScroll } from "@comms/features/messages/ui/useAnchoredScroll";
import { useStableArrayShallow } from "@comms/shared/hooks/useStableReference";
import { cancelManagedAgentTurn } from "@comms/shared/api/agentControl";
...
} from "@comms/shared/layout/AuxiliaryPanel";
...
import { Switch } from "@comms/shared/ui/switch";
import {
  setTranscriptAnimationEnabled,
  useTranscriptAnimationEnabled,
} from "@comms/features/agents/ui/transcriptAnimationPreference";
import {
  setTranscriptTimestampsEnabled,
  useTranscriptTimestampsEnabled,
} from "@comms/features/agents/ui/transcriptTimestampPreference";
import { useLoadArchivedObserverEvents } from "@comms/features/agents/ui/useObserverEvents";
import { useLoadOlderOnScroll } from "@comms/features/messages/ui/useLoadOlderOnScroll";
