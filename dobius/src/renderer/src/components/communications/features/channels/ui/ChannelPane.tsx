...
import { useMediaUpload } from "@comms/features/messages/lib/useMediaUpload";
import { ComposerDockBackdrop } from "@comms/features/messages/ui/ComposerDockBackdrop";
import { MessageComposer } from "@comms/features/messages/ui/MessageComposer";
import { ComposerTimeoutBanner } from "@comms/features/moderation/ui/ComposerTimeoutBanner";
import { useTimeoutState } from "@comms/features/moderation/lib/timeoutStore";
import { isModerationDm } from "@comms/features/moderation/lib/moderationDm";
import { useRelaySelfQuery } from "@comms/features/moderation/hooks";
import { DropZoneOverlay } from "@comms/features/messages/ui/ComposerAttachments";
import { MessageThreadPanel } from "@comms/features/messages/ui/MessageThreadPanel";
import { MessageThreadPanelSkeleton } from "@comms/features/messages/ui/MessageThreadPanelSkeleton";
import {
  MessageTimeline,
  type MessageTimelineHandle,
} from "@comms/features/messages/ui/MessageTimeline";
import { buildDirectMessageIntro } from "@comms/features/channels/lib/dmParticipantDisplay";
import {
  getDmHuddleMemberPubkeys,
  hasOtherDmParticipant,
} from "@comms/features/channels/lib/dmHuddleMembers";
import { buildVideoReviewContextsByMessageId } from "@comms/features/messages/lib/videoReviewContext";
import { useComposerHeightPadding } from "@comms/features/messages/ui/useComposerHeightPadding";
import { UserProfilePanel } from "@comms/features/profile/ui/UserProfilePanel";
import { ChannelFindBar } from "@comms/features/search/ui/ChannelFindBar";
import { AgentSessionThreadPanel } from "@comms/features/channels/ui/AgentSessionThreadPanel";
import { ChannelManagementAuxiliaryPanel } from "@comms/features/channels/ui/ChannelManagementAuxiliaryPanel";
import { RightAuxiliaryPane } from "@comms/features/channels/ui/RightAuxiliaryPane";
import { ThreadViewModeToggle } from "@comms/features/channels/ui/ThreadViewModeToggle";
import { FocusThreadDrawer } from "@comms/features/channels/ui/FocusThreadDrawer";
import { THREAD_SURFACE_KEY } from "@comms/features/channels/lib/threadFocusLayout";
import { getThreadPanelLayout } from "@comms/features/channels/lib/threadPanelLayout";
import { useThreadViewMode } from "@comms/features/channels/lib/threadViewModePreference";
import { useThreadViewModeSwitch } from "@comms/features/channels/ui/useThreadViewModeSwitch";
import { useFocusDrawerPresence } from "@comms/features/channels/ui/useFocusDrawerPresence";
import { useChannelWorkingAgentPubkeys } from "@comms/features/agents/agentWorkingSignal";
import { BotActivityComposerAction } from "@comms/features/channels/ui/BotActivityBar";
import { ChannelComposerActivityAccessory } from "@comms/features/channels/ui/ChannelComposerActivityAccessory";
import {
...
} from "@comms/features/channels/ui/WelcomeComposerBanner";
import {
  isWelcomeSetupSystemMessage,
  mentionsKnownAgent,
} from "@comms/features/channels/ui/ChannelPane.helpers";
import { useChannelIntro } from "@comms/features/channels/ui/useChannelIntro";
import type { ChannelPaneProps } from "@comms/features/channels/ui/ChannelPane.types";
import * as agentSessionSelection from "@comms/features/channels/ui/agentSessionSelection";
import { usePrepareDmSendChannel } from "@comms/features/channels/ui/usePrepareDmSendChannel";
import { Button } from "@comms/shared/ui/button";
import { buildMainTimelineEntries } from "@comms/features/messages/lib/threadPanel";
import { useRenderScopedReactionHydration } from "@comms/features/messages/lib/useRenderScopedReactionHydration";
import type { TimelineMessage } from "@comms/features/messages/types";
import { isWelcomeExperienceChannel as isWelcomeExperience } from "@comms/features/onboarding/welcome";
import { KIND_SYSTEM_MESSAGE } from "@comms/shared/constants/kinds";
import { useIsThreadPanelOverlay } from "@comms/shared/hooks/use-mobile";
import { channelChrome } from "@comms/shared/layout/chromeLayout";
