...
export function hostedCommunityErrorMessage(
  ...
  const messages: Record<string, string> = {
    missing_mapping: "Connect your Dobius identity before creating a community.",
    invalid_name: "Use lowercase letters, numbers, and hyphens.",
    taken: "That Dobius address is already taken.",
    ...
    identity_already_bound:
      "This Builderlab account is connected to another Dobius identity.",
    pubkey_already_bound:
      "This Dobius identity is connected to another Builderlab account.",
    not_owner: "Only the community owner can do that.",
    transferee_not_registered:
      "That person needs a connected Dobius identity before you can transfer ownership to them.",
  };
