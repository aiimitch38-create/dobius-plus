...
/**
 * Seed Dobius localStorage from legacy Sprout WebKit localStorage before the app
 ...
 * Dobius does not already have community state, except for the known broken
 * Sprout→Dobius first-run handoff that created a single localhost community.
 */
