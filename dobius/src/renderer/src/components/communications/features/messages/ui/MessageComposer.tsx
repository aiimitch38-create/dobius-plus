...
import { useChannelLinks } from "@comms/features/messages/lib/useChannelLinks";
import { handleAgentSnapshotPaste } from "@comms/features/messages/lib/agentSnapshotClipboard";
import { useComposerAutofocus } from "@comms/features/messages/lib/useComposerAutofocus";
import type { ChannelSuggestion } from "@comms/features/messages/lib/useChannelLinks";
import { useDrafts } from "@comms/features/messages/lib/useDrafts";
import { resolveSentDraftKey } from "@comms/features/messages/ui/draftSubmitKey";
import { useEmojiAutocomplete } from "@comms/features/messages/lib/useEmojiAutocomplete";
import type { EmojiSuggestion } from "@comms/features/messages/lib/useEmojiAutocomplete";
import { useCustomEmoji } from "@comms/features/custom-emoji/hooks";
import { buildCustomEmojiTags } from "@comms/shared/lib/customEmojiTags";
import {
...
} from "@comms/features/messages/lib/imetaMediaMarkdown";

import { useAttachmentEditing } from "@comms/features/messages/lib/useAttachmentEditing";
import { useMediaUpload } from "@comms/features/messages/lib/useMediaUpload";
import { useMentions } from "@comms/features/messages/lib/useMentions";
import { diffAddedMentionPubkeys } from "@comms/features/messages/lib/threading";
import { getPersistentAgentAudienceScope } from "@comms/features/messages/lib/persistentAgentAudience";
import { useIdentityQuery } from "@comms/shared/api/hooks";
import {
  hasMentionClipboardHtml,
  normalizeMentionClipboardHtml,
} from "@comms/features/messages/lib/normalizeMentionClipboard";
import { CUSTOM_EMOJI_NODE_NAME } from "@comms/features/messages/lib/customEmojiNode";
import {
  type AutocompleteEdit,
  type LinkSelectionInfo,
  useRichTextEditor,
} from "@comms/features/messages/lib/useRichTextEditor";
import { useLinkEditor } from "@comms/features/messages/lib/useLinkEditor";
import { useComposerSpoilerParticles } from "@comms/features/messages/lib/useComposerSpoilerParticles";
import { useTypingBroadcast } from "@comms/features/messages/useTypingBroadcast";
import { getBuzzCodeBlockClipboardText } from "@comms/shared/lib/codeBlockClipboard";
    ...
    richText.editor.setOptions({
      editorProps: {
        ...
        handlePaste: (_view, event) => {
          ...
          // --- Dobius code-block paste ---
          // The code block copy button writes a small Dobius marker alongside
          ...
          // Restore Dobius snapshots before normal styled-HTML normalization.
