...
import { generateBackupPassphrase } from "@comms/shared/api/tauriIdentity";
import { useEncryptedBackup } from "@comms/features/settings/EncryptedBackupProvider";
    ...
    <Dialog onOpenChange={onOpenChange} open={open}>
      <DialogContent className="max-w-lg" data-testid="encrypted-backup-dialog">
        <DialogHeader className="pr-8">
          ...
          <DialogDescription>
            You can close this window while Dobius finishes the backup in the
            background.
          </DialogDescription>
        </DialogHeader>
        <div
        ...
        >
          ...
          {!state.downloadPending && !state.savedPassword ? (
            <p className="text-xs leading-5 text-muted-foreground">
              Keep the file private and save its password somewhere safe — Dobius
