...
const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "buzz-agent": "Dobius's built-in agent runtime, bundled with the app.",
  ...
  cursor: "Cursor's coding agent, connected to Dobius through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to Dobius through its ACP entrypoint.",
