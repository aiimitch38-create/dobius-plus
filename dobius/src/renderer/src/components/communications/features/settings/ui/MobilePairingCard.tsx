...
import { StyledQrCode } from "@comms/shared/ui/styled-qr-code";
import {
  Dialog,
  DialogContent,
  DialogDescription,
              ...
              <div className="space-y-4">
                <div className="flex flex-col items-center gap-3 py-4">
                  ...
                  <p className="text-center text-xs text-muted-foreground">
                    You are about to transfer your Dobius identity to another
  ...
  return (
    <section className="min-w-0" data-testid="settings-mobile">
      <SettingsSectionHeader
        ...
        description={
          <>
            Connect the Dobius mobile app to this relay by scanning a QR code. The
