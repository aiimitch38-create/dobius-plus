...
import { getProjectInboxReference } from "@comms/features/home/lib/projectInbox";
import { ProjectInboxDetail } from "@comms/features/home/ui/ProjectInboxDetail";
import { ChannelMembersBar } from "@comms/features/channels/ui/ChannelMembersBar";
import { useCommunities } from "@comms/features/communities/useCommunities";
import { formatInboxTypeLabel } from "@comms/features/home/lib/inbox";
import { hasInboxThreadContext } from "@comms/features/home/lib/inboxViewHelpers";
import {
  type InboxDisplayMessage,
  InboxMessageRow,
} from "@comms/features/home/ui/InboxMessageRow";
...
} from "@comms/features/messages/lib/messageGrouping";
import { orderMentionPubkeysByText } from "@comms/features/messages/lib/orderMentionPubkeys";
...
import { useAnchoredScroll } from "@comms/features/messages/ui/useAnchoredScroll";
import { useComposerHeightPadding } from "@comms/features/messages/ui/useComposerHeightPadding";
import { UpdateIndicator } from "@comms/features/settings/UpdateIndicator";
import type { Channel, UserProfileSummary } from "@comms/shared/api/types";
import { resolveMentionProps } from "@comms/shared/lib/resolveMentionNames";
import { TopChromeInsetHeader } from "@comms/shared/layout/TopChromeInsetHeader";
...
import {
  ...
  DropdownMenuItem,
  DropdownMenuTrigger,
} from "@comms/shared/ui/dropdown-menu";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@comms/shared/ui/tooltip";

const MembersSidebar = React.lazy(async () => {
  const module = await import("@comms/features/channels/ui/MembersSidebar");
...
/** Routes Inbox selections to their canonical message or Dobius Git detail. */
