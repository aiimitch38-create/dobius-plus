...
import {
  ...
  isProjectInboxItem,
} from "@comms/features/home/lib/projectInbox";
...
export type InboxItem = {
   ...
   * repository-scoped root for Dobius Git work. Does NOT change when a new reply
...
/**
 * Returns the stable conversation ID for any FeedItem or relay event. Dobius Git
