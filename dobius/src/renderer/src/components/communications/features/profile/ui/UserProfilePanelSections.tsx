...
import { MemorySection } from "@comms/features/agent-memory/ui/MemorySection";
import { useAgentWorking } from "@comms/features/agents/agentWorkingSignal";
import { getManagedAgentPrimaryActionLabel } from "@comms/features/agents/lib/managedAgentControlActions";
import { ManagedAgentLogPanel } from "@comms/features/agents/ui/ManagedAgentLogPanel";
import { AgentConfigPanel } from "@comms/features/agents/ui/AgentConfigPanel";
import { getPresenceLabel } from "@comms/features/presence/lib/presence";
import { PresenceDot } from "@comms/features/presence/ui/PresenceBadge";
import type { ProfileActivityAgent } from "@comms/features/profile/lib/profileActivityAgent";
import type {
  useFollowMutation,
  useUnfollowMutation,
  useUserProfileQuery,
...
import {
  type ProfileField,
  ProfileFieldGroup,
} from "@comms/features/profile/ui/UserProfilePanelFields";
import { AGENT_DETAILS_FIELD_LABELS } from "@comms/features/profile/ui/UserProfilePanelAgentDetails";
import {
  ProfileInfoTabContent,
  ProfileIngressRow,
  ProfileRuntimeTabContent,
  ProfileTabBar,
} from "@comms/features/profile/ui/UserProfilePanelTabs";
import {
  MaskedAvatarBadgeFrame,
  STATUS_DOT_MASK_CURVE,
} from "@comms/features/profile/ui/MaskedAvatarBadgeFrame";
...
import type { ManagedAgent, RelayAgent } from "@comms/shared/api/types";
import { Spinner } from "@comms/shared/ui/spinner";
import type {
  ProfileChannelLink,
  ProfilePanelTab,
} from "@comms/features/profile/ui/UserProfilePanelUtils";
import { useFeatureEnabled } from "@comms/shared/features";
import { cn } from "@comms/shared/lib/cn";
import { Alert, AlertDescription, AlertTitle } from "@comms/shared/ui/alert";
import { Badge } from "@comms/shared/ui/badge";
import { Tooltip, TooltipContent, TooltipTrigger } from "@comms/shared/ui/tooltip";

export { AgentInstructionsFocusedView } from "@comms/features/profile/ui/UserProfilePanelAgentDetails";
