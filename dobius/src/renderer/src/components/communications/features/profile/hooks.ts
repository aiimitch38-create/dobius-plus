...
import {
  ...
  getUsersBatch,
  updateProfile,
} from "@comms/shared/api/tauriProfiles";
import { getContactList, setContactList } from "@comms/shared/api/social";
import type { ContactListResponse } from "@comms/shared/api/socialTypes";
import type {
  Profile,
  UpdateProfileInput,
  UserSearchResult,
...
import { getAvatarSnapshotUrl } from "@comms/shared/lib/animatedAvatar";
...
} from "@comms/features/profile/lib/selfProfileStorage";
