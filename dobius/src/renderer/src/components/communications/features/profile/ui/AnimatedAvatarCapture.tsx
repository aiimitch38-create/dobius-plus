...
import {
  ...
  stopAvatarCamera,
} from "@comms/features/profile/lib/animatedAvatarCapture";
import { AnimatedAvatarBackdropPanel } from "@comms/features/profile/ui/AnimatedAvatarBackdropPanel";
import type { AnimatedAvatarCaptureProps } from "@comms/features/profile/ui/AnimatedAvatarCapture.types";
import { AnimatedAvatarCameraControls } from "@comms/features/profile/ui/AnimatedAvatarCameraControls";
import {
  AvatarFilmstripPicker,
  AvatarFramingSlider,
  AvatarOutlineToggle,
} from "@comms/features/profile/ui/AnimatedAvatarControls";
import {
  ...
  randomBackdropColor,
} from "@comms/features/profile/ui/AnimatedAvatarCapture.helpers";
import {
  AnimatedAvatarReviewNav,
  type ReviewSection,
} from "@comms/features/profile/ui/AnimatedAvatarReviewNav";
import { AvatarCustomColorPanel } from "@comms/features/profile/ui/AvatarCustomColorPanel";
import {
  AVATAR_COLORS,
  hexToHsv,
  hsvToHex,
  normalizeHue,
} from "@comms/features/profile/ui/ProfileAvatarEditor.utils";
import { uploadMediaBytes } from "@comms/shared/api/tauri";
import { buildAnimatedAvatarUrl } from "@comms/shared/lib/animatedAvatar";
  ...
  const startCamera = React.useCallback(
    async (cameraId = selectedCameraId, source = selectedCameraSource) => {
      ...
      try {
        ...
        releaseCamera();
        setErrorMessage(
          "Could not access the camera. Check Dobius's camera permission and try again.",
        );
        setPhase("idle");
      }
    },
