...
import {
  useAgentMemoryQuery,
  useIsManagedAgent,
} from "@comms/features/agent-memory/hooks";
import {
...
import { useGlobalAgentConfig } from "@comms/features/agents/useGlobalAgentConfig";
import { AddAgentToChannelDialog } from "@comms/features/agents/ui/AddAgentToChannelDialog";
import {
  availableRuntimesForStart,
  buildInstanceInputForDefinition,
  resolveStartRuntimeForDefinition,
} from "@comms/features/agents/lib/instanceInputForDefinition";
import { describeLogFile } from "@comms/features/agents/ui/agentUi";
import { AgentDialog } from "@comms/features/agents/ui/AgentDialog";
import { useAgentLifecycleActions } from "@comms/features/profile/ui/useAgentLifecycleActions";
import {
  consumePendingOpenEditAgent,
  type EditAgentFocusTarget,
  subscribeOpenEditAgent,
} from "@comms/features/agents/openEditAgentEvent";
import {
  duplicatePersonaDialogState,
  editPersonaDialogState,
  type PersonaDialogState,
} from "@comms/features/agents/ui/personaDialogState";
import { useChannelsQuery } from "@comms/features/channels/hooks";
import { useIdentityArchive } from "@comms/features/identity-archive/hooks";
import { usePresenceQuery } from "@comms/features/presence/hooks";
import {
  useContactListQuery,
  useFollowMutation,
  useProfileQuery,
  ...
  useUserProfileQuery,
  useUsersBatchQuery,
} from "@comms/features/profile/hooks";
import { ownsAuthorAgent } from "@comms/features/profile/lib/identity";
import { resolveProfileActivityAgent } from "@comms/features/profile/lib/profileActivityAgent";
import {
  ...
  MemoryFocusedView,
  ProfileSummaryView,
} from "@comms/features/profile/ui/UserProfilePanelSections";
import { AgentConfigurationFocusedView } from "@comms/features/profile/ui/UserProfilePanelAgentDetails";
import { UserProfileAgentSettingsMenuSlot } from "@comms/features/profile/ui/UserProfileAgentActions";
import { useProfileAgentDeletion } from "@comms/features/profile/ui/UserProfilePanelDeletion";
import { useProfileFieldBuckets } from "@comms/features/profile/ui/UserProfilePanelFields";
import { submitProfilePersonaDialog } from "@comms/features/profile/ui/UserProfilePanelPersonaSubmit";
import { UserProfilePersonaDialogs } from "@comms/features/profile/ui/UserProfilePersonaDialogs";
import { UserProfileSnapshotExportDialog } from "@comms/features/profile/ui/UserProfileSnapshotExportDialog";
import {
...
import { useProfileDmAction } from "@comms/features/profile/ui/useProfileDmAction";
import { useUserStatusQuery } from "@comms/features/user-status/hooks";
import { useOpenAgentActivity } from "@comms/features/agents/useOpenAgentActivity";
...
import { UserProfilePanelFrame } from "@comms/features/profile/ui/UserProfilePanelFrame";
import { getUserProfilePanelHeaderContent } from "@comms/features/profile/ui/UserProfilePanelHeaderContent";
