...
import { useHuddle } from "@comms/features/huddle";
import { formatHuddleActionError } from "@comms/features/huddle/lib/huddleError";
import {
  channelsQueryKey,
  useChannelsQuery,
  useOpenDmMutation,
...
import { channelMessagesKey } from "@comms/features/messages/lib/messageQueryKeys";
import {
  useRelayAgentsQuery,
  useManagedAgentsQuery,
} from "@comms/features/agents/hooks";
import { useIsManagedAgent } from "@comms/features/agent-memory/hooks";
import { useIdentityQuery } from "@comms/shared/api/hooks";
import { useAgentWorking } from "@comms/features/agents/agentWorkingSignal";
import {
  formatOwnerLabel,
  ownsAuthorAgent,
} from "@comms/features/profile/lib/identity";
import { formatElapsed } from "@comms/features/agents/ui/agentSessionUtils";
...
import { StatusEmoji } from "@comms/features/user-status/ui/StatusEmoji";
import { ProfileAvatarWithStatus } from "@comms/features/profile/ui/ProfileAvatarWithStatus";
import {
  createOptimisticMessage,
  mergeTimelineCacheMessages,
} from "@comms/features/messages/hooks";
import { buildWaveMessageContent } from "@comms/features/messages/lib/waveMessage";
import { useOpenAgentActivity } from "@comms/features/agents/useOpenAgentActivity";
import { useProfilePanel } from "@comms/shared/context/ProfilePanelContext";
import { sendChannelMessage } from "@comms/shared/api/tauri";
import type { Channel, RelayEvent } from "@comms/shared/api/types";
import { KIND_STREAM_MESSAGE } from "@comms/shared/constants/kinds";
import { cn } from "@comms/shared/lib/cn";
import { normalizePubkey, truncatePubkey } from "@comms/shared/lib/pubkey";

import { Popover, PopoverAnchor, PopoverContent } from "@comms/shared/ui/popover";
import { BotIdenticon } from "@comms/features/messages/ui/BotIdenticon";
