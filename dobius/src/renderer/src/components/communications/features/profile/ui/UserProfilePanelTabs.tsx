...
import type { ManagedAgent } from "@comms/shared/api/types";
import type { ActiveTurnSummary } from "@comms/features/agents/activeAgentTurnsStore";
import { ManagedAgentSessionPanel } from "@comms/features/agents/ui/ManagedAgentSessionPanel";
import {
  AgentDetailsRows,
  AgentInstructionRow,
} from "@comms/features/profile/ui/UserProfilePanelAgentDetails";
import type { ProfileActivityAgent } from "@comms/features/profile/lib/profileActivityAgent";
import { resolveActivityChannelId } from "@comms/features/profile/lib/profileActivityCarousel";
import {
  type ProfileActivityFeedScope,
  useProfileActivityFeedScope,
} from "@comms/features/profile/lib/profileActivityFeedScope";
import {
  type ProfileField,
  ProfileFieldGroup,
  ProfileFieldRows,
} from "@comms/features/profile/ui/UserProfilePanelFields";
import type { ProfilePanelTab } from "@comms/features/profile/ui/UserProfilePanelUtils";
        ...
        >
          ...
          <div className="min-w-0 text-sm">
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              {autoRestartEnabled
                ? "Configuration changed since this agent started. Dobius can restart it automatically after ~3 minutes idle, or stop and respawn it to apply now."
