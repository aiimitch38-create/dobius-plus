...
import {
  ...
  type ScopeType,
} from "@comms/shared/api/tauriArchive";
import {
...
import {
  SettingsOptionGroup,
  SettingsOptionRow,
} from "@comms/features/settings/ui/SettingsOptionGroup";
import { SettingsSectionHeader } from "@comms/features/settings/ui/SettingsSectionHeader";
import { observerArchiveDefaultEnabled } from "@comms/shared/api/tauriArchive";
  ...
  return (
    <section className="min-w-0" data-testid="settings-local-archive">
      <SettingsSectionHeader
        title="Local archive"
        description="Save copies of relay messages to a local SQLite database in your Dobius data folder. Events are re-verified against the relay at archive time."
      />
