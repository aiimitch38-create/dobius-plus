...
import { useHomeFeedQuery } from "@comms/features/home/hooks";
...
import type { Channel, FeedItem, HomeFeedResponse } from "@comms/shared/api/types";
import {
      ...
      if (nextPermission !== "granted") {
        ...
        setErrorMessage(
          nextPermission === "denied"
            ? "Desktop notifications are blocked for Dobius+. Enable them in system settings to turn alerts on."
