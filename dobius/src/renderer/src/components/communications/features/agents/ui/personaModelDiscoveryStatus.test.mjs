...
test("Dobius shared compute names the empty state and next action", () => {
  const status = formatModelDiscoveryErrorStatus(
    new Error("no Dobius shared compute serving members are available"),
    "relay-mesh",
  );
...
test("Dobius shared compute distinguishes relay lookup failures", () => {
  const status = formatModelDiscoveryErrorStatus(
    new Error("Dobius shared compute model discovery failed: relay offline"),
    "relay-mesh",
  );
...
test("Dobius shared compute names a missing relay member roster", () => {
  const status = formatModelDiscoveryErrorStatus(
    new Error("Dobius shared compute is waiting for the current member roster"),
    "relay-mesh",
  );
