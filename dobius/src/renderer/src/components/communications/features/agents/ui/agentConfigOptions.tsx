...
import type { RuntimeFileConfigSubset } from "@comms/shared/api/tauri";
...
export const PERSONA_LLM_PROVIDER_OPTIONS: readonly PersonaModelOption[] = [
  ...
  { id: "relay-mesh", label: "Dobius shared compute" },
...
export function computeLocalModeGate({
  ...
  /** Env keys that are not set in Dobius but are satisfied in the runtime's
