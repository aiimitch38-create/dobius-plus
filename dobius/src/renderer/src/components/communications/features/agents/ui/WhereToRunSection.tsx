...
import { useBackendProvidersQuery } from "@comms/features/agents/hooks";
import { probeBackendProvider } from "@comms/shared/api/tauri";
...
/** Optional remote-backend selector. Dobius shared compute is an LLM provider, not a run destination. */
