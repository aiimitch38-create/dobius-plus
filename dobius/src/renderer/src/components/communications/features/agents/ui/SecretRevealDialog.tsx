import type { AgentChannelAttachmentFailure } from "@comms/features/agents/channelAttachmentFailure";
import type { CreateManagedAgentResponse } from "@comms/shared/api/types";
          ...
          <DialogHeader className="border-b border-border/60 px-6 py-5 pr-14">
            ...
            <DialogDescription>
              {created?.privateKeyNsec
                ...
                : "Dobius created this agent and manages its runtime identity securely."}
            </DialogDescription>
          </DialogHeader>
                ...
                {created.privateKeyNsec ? (
                  <div className="rounded-2xl border border-border/70 bg-muted/20 p-4">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <CopyButton label="Copy key" value={created.privateKeyNsec} />
                    </div>
