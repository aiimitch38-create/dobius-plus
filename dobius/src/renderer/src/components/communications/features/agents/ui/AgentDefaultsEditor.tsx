...
} from "@comms/shared/api/tauriGlobalAgentConfig";
import type { GlobalAgentConfig } from "@comms/shared/api/types";
import { getBakedBuildEnv, type BakedEnvEntry } from "@comms/shared/api/tauri";
import { globalAgentConfigQueryKey } from "@comms/features/agents/useGlobalAgentConfig";
import {
  useAcpRuntimesQuery,
...
import { AgentDropdownSelect } from "@comms/features/agents/ui/agentConfigControls";
import {
  AgentConfigFields,
  EMPTY_GLOBAL_CONFIG,
} from "@comms/features/agents/ui/AgentConfigFields";
...
export function AgentDefaultsEditor({
  ...
  // An unset preferred runtime uses the same Dobius Agent-first fallback as
