...
// catalog entry has command="/Applications/Dobius.app/.../buzz-agent" (resolved path).
...
test("editAgent_bugA_inheritedShortName_resolvesViaIdFallback", () => {
  ...
  const runtimes = [
    {
      id: "buzz-agent",
      command: "/Applications/Dobius.app/Contents/MacOS/buzz-agent", // resolved path
...
test("editAgent_bugA_inheritedShortName_discoveryGatePasses", () => {
  ...
  const runtimes = [
    {
      id: "buzz-agent",
      command: "/Applications/Dobius.app/Contents/MacOS/buzz-agent",
      availability: "available",
      defaultArgs: [],
    },
  ];
  ...
  assert.equal(
    ...
    "/Applications/Dobius.app/Contents/MacOS/buzz-agent",
