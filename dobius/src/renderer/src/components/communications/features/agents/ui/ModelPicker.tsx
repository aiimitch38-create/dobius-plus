...
import type { AgentModelsResponse, ManagedAgent } from "@comms/shared/api/types";
import { getAgentModels, updateManagedAgent } from "@comms/shared/api/tauri";
import { switchManagedAgentModel } from "@comms/shared/api/agentControl";
import { awaitLiveSwitchOutcome } from "@comms/features/agents/lib/liveSwitchOutcome";
import { subscribeControlResults } from "@comms/features/agents/observerRelayStore";
import { useActiveAgentTurns } from "@comms/features/agents/activeAgentTurnsStore";
import {
...
export function ModelPicker({
  ...
  // Dobius setting (which is already self-evident from the picker state).
