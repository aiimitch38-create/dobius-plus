...
import { usePersonasQuery } from "@comms/features/agents/hooks";
...
} from "@comms/shared/context/ProfilePanelContext";
...
const AgentsView = React.lazy(async () => {
  const module = await import("@comms/features/agents/ui/AgentsView");
