...
import { FeatureGate } from "@comms/shared/features";
import { SidebarDndContext } from "@comms/features/sidebar/ui/SidebarDnd";

import type { Community } from "@comms/features/communities/types";
import { AddCommunityDialog } from "@comms/features/communities/ui/AddCommunityDialog";
import type { AddCommunityPrefillRequest } from "@comms/features/communities/addCommunityPrefill";
import { useIsMobile } from "@comms/shared/hooks/use-mobile";
import { useDeferredLoad } from "@comms/shared/hooks/useDeferredStartup";
import {
  useChannelSections,
  type ChannelSection,
} from "@comms/features/sidebar/lib/useChannelSections";
import { useActiveWorkingChannelsById } from "@comms/features/sidebar/lib/useActiveWorkingChannelsById";
import { useDmSidebarMetadata } from "@comms/features/sidebar/useDmSidebarMetadata";
import { sortDmChannelsForSidebar } from "@comms/features/sidebar/lib/dmSidebarSort";
import {
  sectionSortGroupKey,
  sortChannelsForSidebar,
} from "@comms/features/sidebar/lib/channelSortPreference";
import { useChannelSortPreference } from "@comms/features/sidebar/lib/useChannelSortPreference";
import { useSidebarScrollLock } from "@comms/features/sidebar/lib/useSidebarScrollLock";
import { isSidebarBackgroundTarget } from "@comms/features/sidebar/lib/sidebarBackgroundTarget";
import { useUnreadOverflow } from "@comms/features/sidebar/lib/useUnreadOverflow";
import {
  CreateSectionDialog,
...
} from "@comms/features/sidebar/ui/ChannelSectionDialogs";
import {
  AppSidebarPinnedHeader,
  AppSidebarPrimaryMenu,
} from "@comms/features/sidebar/ui/AppSidebarPinnedHeader";
import { MoreUnreadButton } from "@comms/features/sidebar/ui/MoreUnreadButton";
import { SidebarSection } from "@comms/features/sidebar/ui/SidebarSection";
import {
  ChannelGroupSection,
  CustomChannelSection,
  SectionActionsMenu,
  SectionQuickAction,
} from "@comms/features/sidebar/ui/CustomChannelSection";
import { CreateChannelDialog } from "@comms/features/sidebar/ui/CreateChannelDialog";
import { SidebarProfileCard } from "@comms/features/sidebar/ui/SidebarProfileCard";
import { SidebarRelayConnectionCard } from "@comms/features/sidebar/ui/SidebarRelayConnectionCard";
import type { useSidebarRelayConnectionCard } from "@comms/features/sidebar/ui/useSidebarRelayConnectionCard";
import {
  SidebarLoadingContent,
  useSidebarLoadingShape,
} from "@comms/features/sidebar/ui/sidebarLoadingSkeleton";
import { useDeferredModalOpen } from "@comms/shared/ui/deferredModalOpen";
import { SidebarUpdateCard } from "@comms/features/settings/SidebarUpdateCard";
import { useUpdaterContext } from "@comms/features/settings/hooks/UpdaterProvider";
import { shouldShowSidebarUpdateCard } from "@comms/features/settings/sidebarUpdateCardVisibility";
import type { SettingsSection } from "@comms/features/settings/ui/SettingsPanels";
import type {
  Channel,
  ChannelVisibility,
  PresenceStatus,
