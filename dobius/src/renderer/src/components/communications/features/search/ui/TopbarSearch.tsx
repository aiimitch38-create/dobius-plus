...
import {
  ...
  useSearchResults,
} from "@comms/features/search/useSearchResults";
import {
  resultIcon,
  resultKey,
  resultTestId,
  type SearchResult,
} from "@comms/features/search/ui/SearchResultItem";
import { SearchPromptPlaceholder } from "@comms/features/search/ui/SearchPromptPlaceholder";
import type { Channel, SearchHit, UserSearchResult } from "@comms/shared/api/types";
