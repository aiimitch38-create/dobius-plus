...
import { initializeStarterChannels } from "@comms/features/onboarding/hooks";
import { useClaimInvite } from "@comms/features/onboarding/useClaimInvite";
...
} from "@comms/features/onboarding/welcome";
import { useAvatarPresentation } from "@comms/features/profile/avatarPresentationStore";
import { registerAvatarWhenReady } from "@comms/features/profile/avatarProfileSync";
import { profileQueryKey } from "@comms/features/profile/hooks";
import { ProfileAvatar } from "@comms/features/profile/ui/ProfileAvatar";
import {
  parseEmojiAvatarDataUrl,
  ProfileAvatarEditor,
} from "@comms/features/profile/ui/ProfileAvatarEditor";
import { getProfile, updateProfile } from "@comms/shared/api/tauriProfiles";
import { getIdentity, importIdentity } from "@comms/shared/api/tauriIdentity";
import { listPersonas } from "@comms/shared/api/tauriPersonas";
import { relayClient } from "@comms/shared/api/relayClient";
import type { AgentPersona } from "@comms/shared/api/types";
...
import { Dialog, DialogContent, DialogTitle } from "@comms/shared/ui/dialog";
...
const STARTER_PERSONA_ANIMATIONS: Record<string, string> = {
  Iris: "/onboarding/starter-team/iris.png",
  Atlas: "/onboarding/starter-team/atlas.png",
          ...
          transaction.stage === "connecting" ? (
            ...
            <>
              ...
              <p className="mx-auto mt-3 max-w-[400px] text-sm leading-6 text-foreground/80">
                Dobius lets you bring multiple agents into the same workspace.
                Your team will help you get started using Dobius.
              </p>
