...
import { clearActiveTurnsForAgentOnStop } from "@comms/features/agents/managedAgentRuntimeHooks";
import { useCommunities } from "@comms/features/communities/useCommunities";
import { welcomeKickoffMarker } from "@comms/features/onboarding/devFreshOnboarding";
import { resolveAgentReadiness } from "@comms/features/onboarding/ui/agentReadiness";
import {
  ensureWelcomeTeam,
  pickWelcomeTeamStarterAgentForRelay,
  WELCOME_TEAM_STARTERS,
  type WelcomeTeamStarterDefinition,
} from "@comms/features/onboarding/welcomeGuide";
import { isWelcomeChannel } from "@comms/features/onboarding/welcome";
...
import {
  startManagedAgent,
  stopManagedAgent,
} from "@comms/shared/api/tauriManagedAgents";
import { hasManagedAgentChannelMessageMarker } from "@comms/shared/api/tauriManagedAgentMessageMarkers";
import { sendManagedAgentChannelMessage } from "@comms/shared/api/tauriManagedAgentMessages";
import { getPresence, listManagedAgents } from "@comms/shared/api/tauri";
import { getProfile } from "@comms/shared/api/tauriProfiles";
import type { Channel, ManagedAgent, RelayEvent } from "@comms/shared/api/types";
...
export function buildWelcomeKickoffOpener(
  ...
  if (introTeammates.length === 0) {
    ...
    return `${greeting} Welcome to Dobius. This is your private home base, and I'm here${teammatePhrase} to help you get oriented or work through something you're building.\n\n${WELCOME_KICKOFF_CTA}`;
  }

  return `${greeting} Welcome to Dobius. This is your private home base, and we're here to help you get oriented or work through something you're building.\n\n${introNames}, introduce ${introTeammates.length === 1 ? "yourself" : "yourselves"} in a sentence or two — share what you're good at and when to bring you in. Don't start any work yet.`;
}
