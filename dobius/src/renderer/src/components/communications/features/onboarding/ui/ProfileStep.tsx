...
import { SidebarRelayConnectionCompactCard } from "@comms/features/sidebar/ui/SidebarRelayConnectionCard";
import { useRelayConnection } from "@comms/shared/api/useRelayConnection";
import { useReconnectRelay } from "@comms/shared/api/useReconnectRelay";
    ...
    >
      <div className="w-full max-w-2xl">
        ...
        <p className="mt-5 text-sm leading-6 text-muted-foreground">
          Pick the name people and agents will see in Dobius. You can change it
          anytime.
        </p>
      </div>
