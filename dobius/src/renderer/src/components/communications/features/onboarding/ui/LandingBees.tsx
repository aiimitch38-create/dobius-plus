...
const BEES: Mote[] = [
  ...
  { top: "7%", left: "58%", size: 28, rotate: 18, color: INK },
  { top: "5%", left: "88%", size: 32, rotate: -20, color: WHITE },
  { top: "13%", left: "12%", size: 36, rotate: 18, color: INK },
  { top: "12%", left: "73%", size: 26, rotate: -8, color: WHITE },
  { top: "18%", left: "44%", size: 24, rotate: 25, color: INK },
  { top: "22%", left: "90%", size: 34, rotate: 10, color: WHITE },
  { top: "28%", left: "5%", size: 28, rotate: -18, color: INK },
  { top: "31%", left: "21%", size: 24, rotate: 8, color: INK },
  { top: "35%", left: "84%", size: 32, rotate: -14, color: WHITE },
  { top: "45%", left: "13%", size: 32, rotate: 20, color: INK },
  { top: "47%", left: "93%", size: 26, rotate: -6, color: INK },
  { top: "55%", left: "30%", size: 26, rotate: -24, color: WHITE },
  { top: "57%", left: "70%", size: 34, rotate: 12, color: INK },
  { top: "63%", left: "8%", size: 34, rotate: 16, color: WHITE },
  { top: "66%", left: "88%", size: 28, rotate: -10, color: INK },
  { top: "72%", left: "48%", size: 26, rotate: 22, color: INK },
  { top: "76%", left: "18%", size: 32, rotate: -16, color: WHITE },
  { top: "80%", left: "64%", size: 28, rotate: 8, color: INK },
  { top: "86%", left: "34%", size: 34, rotate: -20, color: WHITE },
  { top: "88%", left: "80%", size: 32, rotate: 14, color: INK },
  { top: "92%", left: "10%", size: 26, rotate: -8, color: INK },
  { top: "3%", left: "42%", size: 22, rotate: 14, color: WHITE },
  { top: "9%", left: "5%", size: 24, rotate: -22, color: INK },
  { top: "16%", left: "62%", size: 30, rotate: -4, color: INK },
  { top: "20%", left: "30%", size: 22, rotate: 12, color: WHITE },
  { top: "26%", left: "52%", size: 26, rotate: -14, color: INK },
  { top: "33%", left: "68%", size: 22, rotate: 24, color: WHITE },
  { top: "40%", left: "40%", size: 24, rotate: -10, color: INK },
  { top: "42%", left: "78%", size: 28, rotate: 6, color: INK },
  { top: "52%", left: "55%", size: 22, rotate: -18, color: WHITE },
  { top: "60%", left: "42%", size: 28, rotate: 10, color: INK },
  { top: "68%", left: "26%", size: 24, rotate: -6, color: WHITE },
  { top: "70%", left: "76%", size: 30, rotate: 18, color: INK },
  { top: "82%", left: "6%", size: 28, rotate: 22, color: WHITE },
  { top: "84%", left: "50%", size: 24, rotate: -12, color: INK },
  { top: "94%", left: "60%", size: 28, rotate: 16, color: INK },
  { top: "95%", left: "90%", size: 22, rotate: -24, color: WHITE },
];

const REPEL_RADIUS = 180;
const REPEL_STRENGTH = 110;
// Autonomous wander: each mote drifts on its own smooth loop.
const WANDER_X = 26;
const WANDER_Y = 20;
...
export function LandingBees() {
  ...
  return (
    ...
    >
      ...
      {/* Upstream scattered 38 copies of its bee mark here. Repeating a
          product's own logo 38 times reads as filler rather than branding, so
          the field is now plain motes — same drift, same cursor repulsion, no
          logo soup. */}
      {BEES.map((bee, i) => (
        <span
          ...
          style={{
            ...
            width: bee.size * 0.3,
            height: bee.size * 0.3,
            background: bee.color,
            opacity: bee.color === WHITE ? 0.55 : 0.32,
          }}
        />
      ))}
    </div>
