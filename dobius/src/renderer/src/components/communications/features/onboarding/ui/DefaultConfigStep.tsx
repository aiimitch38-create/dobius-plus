...
import { resetConfigForHarnessChange } from "@comms/features/agents/ui/agentConfigOptions";
...
function formatHarnessLabel(runtime: AcpRuntimeCatalogEntry | undefined) {
  ...
  return runtime.id === "buzz-agent" ? "Dobius" : runtime.label;
}
    ...
    >
      <div className="w-full max-w-[500px] text-center">
        ...
        <p className="mx-auto mt-3 max-w-[440px] text-sm leading-5 text-foreground/80">
          This will be set as your default model configuration across Dobius. You
