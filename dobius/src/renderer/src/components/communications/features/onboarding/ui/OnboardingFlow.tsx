...
import { getMyRelayMembershipLookup } from "@comms/shared/api/relayMembers";
import { isRelayUnreachableError } from "@comms/shared/lib/relayError";
import {
  getIdentity,
  importIdentity,
  persistCurrentIdentity,
} from "@comms/shared/api/tauriIdentity";
                  ...
                  {identityLost ? (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Re-import your nsec to restore it — Dobius will restart to
                    ...
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Dobius. If this key already has a profile on the relay,
