import { getCanvas, setCanvas } from "@comms/shared/api/tauri";

export const WELCOME_CANVAS_CONTENT = `# Welcome to Dobius

This private channel is your home base for getting oriented. Iris, Atlas, and Sage can help you learn the app, troubleshoot setup, and work through something you are building.
...
Ask the team a question here, or read the [Dobius user guide](https://github.com/block/buzz#readme).
`;
