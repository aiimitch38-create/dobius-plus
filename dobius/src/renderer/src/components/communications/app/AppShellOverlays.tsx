...
import type { CreateChannelInput } from "@comms/features/sidebar/lib/useCreateChannelForm";
import { useDeferredModalOpen } from "@comms/shared/ui/deferredModalOpen";

const ChannelBrowserDialog = React.lazy(async () => {
  const module = await import("@comms/features/channels/ui/ChannelBrowserDialog");
  return { default: module.ChannelBrowserDialog };
});

const ChannelManagementSheet = React.lazy(async () => {
  const module = await import("@comms/features/channels/ui/ChannelManagementSheet");
