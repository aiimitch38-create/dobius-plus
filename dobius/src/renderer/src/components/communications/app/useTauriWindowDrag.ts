...
import { isWindowDragHandleEvent } from "@comms/app/AppShell.helpers";
import { performTitleBarDoubleClickAction } from "@comms/shared/lib/titleBarActions";
...
export function useTauriWindowDrag() {
  React.useEffect(() => {
    ...
    function stopTauriDragRegionHandler(event: MouseEvent) {
      ...
      // double-click. Dobius handles drag and double-click itself so macOS title
