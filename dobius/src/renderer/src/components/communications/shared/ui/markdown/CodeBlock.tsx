...
import { useTheme } from "@comms/shared/theme/ThemeProvider";
import { resolveShikiThemeName } from "@comms/shared/theme/theme-loader";
import { copyCodeBlockToClipboard } from "@comms/shared/lib/codeBlockClipboard";
...
export function SyntaxHighlightedCode({
  ...
  // Dobius aliases ("buzz" / "buzz-dark") are not bundled Shiki themes — resolve
