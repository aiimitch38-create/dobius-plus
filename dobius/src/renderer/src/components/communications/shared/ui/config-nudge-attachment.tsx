...
import type { ConfigNudgePayload } from "@comms/shared/lib/configNudge";
...
function RequirementRow({
  ...
  switch (requirement.surface) {
    ...
    case "cli_config_invalid": {
      ...
      // external file. No Agent runtimes CTA (Dobius can't repair ~/.codex/config.toml)
      // and no Edit Agent CTA (the field isn't managed by Dobius).
