/**
 * Community icon, Dobius extension to NIP-43 + standard NIP-11 `icon`.
 *
...
import { invokeTauri, signRelayEvent } from "@comms/shared/api/tauri";

/** Dobius: admin command to set the community profile (icon). */
