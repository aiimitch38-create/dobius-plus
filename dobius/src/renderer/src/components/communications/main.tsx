...
import { NostrBindConsentDialog } from "@comms/features/profile/ui/NostrBindConsentDialog";
import "@fontsource-variable/inter/wght.css";
import "@comms/shared/styles/globals.css";
import { UpdaterProvider } from "@comms/features/settings/hooks/UpdaterProvider";
import { migrateLegacyCommunityStorageBeforeRender } from "@comms/features/communities/legacyCommunityStorage";
...
import { recoverLocalStorageQuotaOnStartup } from "@comms/shared/lib/localStorageQuota";
...
function resetDevWebviewStateFromUrl() {
  ...
  // WebKit groups every Dobius binary under one disk directory, but storage is
...
async function installE2eBridgeIfConfigured() {
  ...
  const { maybeInstallE2eTauriMocks } = await import("@comms/testing/e2eBridge");
